...
(function () {
  ...
  // ---------------------------------------------------------------------------
  // ช่องทางติดต่อร้าน (LINE / เบอร์โทร / แผนที่) — ปุ่มกลมมีไอคอน ใช้ทั้งหน้าร้านและหน้าสั่งอาหารของลูกค้า
  // จัดเป็น 2 แถวชิดขวา: แถวบน LINE · แถวล่าง เบอร์โทรร้าน + แผนที่
